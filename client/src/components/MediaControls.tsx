    ...
    return (
      <div className="flex flex-col items-center gap-2 sm:gap-3">
        <button
          ...
          className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 disabled:cursor-not-allowed text-white rounded-lg transition-colors text-xs sm:text-sm"
        >
          {isInitializing ? (
            <>
            ...
            <>
              ...
              <span className="hidden sm:inline">Enable Video/Voice</span>
